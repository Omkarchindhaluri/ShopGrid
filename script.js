var productList = [
  ...
  var paragraph=document.createElement("h4");
   ...
   paragraph.innerHTML=productList[i].brand;
  ...
  mainSection.appendChild(headerTag2);
  
  //accessories section
  var accessoriesSection=document.createElement("div");
           accessoriesSection.className="cloths-id";
  ...
  mainSection.appendChild(accessoriesSection);
